This is PetSimulator in which we will select the pet by entering the input and after that we will write the name of the pet.After that we will go to Main menu where we will select the optin like
Main Menu:
1. Feed kitty
2. Play with kitty
3. Let kitty Rest
